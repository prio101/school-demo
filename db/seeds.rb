...
# end
AdminUser.create(email: 'admin@school.com', password: '12345678', password_confirmation: '12345678')
school = School.create(name: 'pmcbd', domain: 'http://pmcbd.com', code: '1234')
